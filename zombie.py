...
def play_game():
        ...
        while (health > 0 and zombies_left > 0):
            ...
            print("Zombies have arrived! There are", zombies, "zombies.")
            ...
            if (outcome == "You fought the zombies and emerged victorious!"):
                ...
                zombies_left -= zombies
                health -= 20
            elif (outcome == "You tried to run, but the zombies caught you. You died." or outcome == "You hid from the zombies, but they found you. You died."):
                health = 0
                break
            print("You have", health, "health left, there are", zombies_left, "zombies left, and you have", food, "food left.")
        if (health <= 0):
